...
pers_sw_wx_plot_data <- ggplot() +  
  ...
  geom_line(data = filtered_daily_persb_wx, aes(x = date, y = avg_swout_wperm2, color = "avg_swout_wperm2"), alpha = 0.9) +
  labs(
...
trans_sw_wx_plot_data <- ggplot() +  
  ...
  geom_line(data = filtered_daily_transb_wx, aes(x = date, y = avg_swout_wperm2, color = "avg_swout_wperm2"), alpha = 0.9) +
  labs(
